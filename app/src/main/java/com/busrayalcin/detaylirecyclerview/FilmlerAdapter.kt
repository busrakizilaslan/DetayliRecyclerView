...
import com.busrayalcin.detaylirecyclerview.databinding.CardTasarimBinding
...
class FilmlerAdapter(var mContext:Context,var filmlerListesi:List<Filmler>)
    ...
    override fun onBindViewHolder(holder: CardTasarimTutucu, position: Int) {
        ...
        t.imageViewFilmResim.setImageResource(
            mContext.resources.getIdentifier(film.filminResimAdi,"drawable",mContext.packageName))
